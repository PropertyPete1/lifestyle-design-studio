...
## Incompetech (Kevin MacLeod) — CC-BY 4.0. APPROVED.
...
checking a track against YouTube's own library before committing it.

Mitigation: prefer tracks with no aggregator history, and keep the licence
evidence for each track beside it in the Drive folder so a dispute is a
paperwork exercise rather than an investigation.
